...
some RSS services (such as inoreader, of which I am a paid user) allow following a twitter user as a feed, but I created this project for the following reasons:
 - to allow me to filter replies out of the feed
 - to create a more concise article body
